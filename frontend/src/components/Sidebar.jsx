            ...
            {[
              {
                ...
                sub: "Filters & controls traffic",
                cls: "palette-icon-firewall",
                Icon: Shield,
              },
              {
                type: "server",
                label: "Enterprise Server",
                sub: "Hosts services & databases",
                cls: "palette-icon-server",
                Icon: Server,
              },
              {
                type: "default",
                label: "User Workstation",
                sub: "Endpoint & lateral pivot",
                cls: "palette-icon-workstation",
                Icon: Laptop,
              },
              {
                type: "router",
                label: "Network Router",
                sub: "Routes packets between nets",
                cls: "palette-icon-router",
                Icon: Network,
              },
              {
                type: "database",
                label: "Database Server",
                sub: "Structured data store",
                cls: "palette-icon-database",
                Icon: Database,
              },
              {
                type: "loadbalancer",
                label: "Load Balancer",
                sub: "Distributes ingress traffic",
                cls: "palette-icon-loadbalancer",
                Icon: GitMerge,
              },
              {
                type: "cloud",
                label: "Cloud Service",
                sub: "SaaS / CDN / cloud endpoint",
                cls: "palette-icon-cloud",
                Icon: Cloud,
              },
          ...
          <div className="trace-panel">
            ...
            {simulationPath.length > 0 ? (
              ...
              <p className="trace-empty">
                No simulation yet. Press <strong>Run Simulation</strong> to
                begin.
              </p>
            )}
          </div>
